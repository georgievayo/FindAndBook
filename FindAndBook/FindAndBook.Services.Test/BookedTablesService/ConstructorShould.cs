...
namespace FindAndBook.Services.Test.BookedTablesService
{
    ...
    public class ConstructorShould
    {
        ...
        public void ConstructorShould_ThrowException_WhenRepositoryIsNull()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new Services.BookedTablesService(null,
                unitOfWorkMock.Object, factoryMock.Object));
        }
        ...
        public void ConstructorShould_ThrowException_WhenUnitOfWorkIsNull()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new Services.BookedTablesService(repositoryMock.Object,
